...
def run_pipeline():
    ...
    if not signals:
        print('  ⚠ 无信号，退出')
        return {"signals": [], "opportunities": [], "action_plans": []}
    ...
    if not opportunities:
        ...
        return {"signals": signals, "opportunities": [], "action_plans": []}
    ...
    return {"signals": signals, "opportunities": opportunities, "action_plans": action_plans}
